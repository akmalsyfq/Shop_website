...
if (isset($_GET['id'])) {
    include_once("dbconnect.php");
    $pcode = $_GET['id'];
    $sqlproduct = "SELECT * FROM products WHERE code = '$pcode'";
        ...
        <div class="w3-card-4 w3-round">
            ...
            <form class="w3-container w3-padding" name="registerForm" method="post" enctype="multipart/form-data" onsubmit="return updateDialog()" >
                <div class="w3-container w3-border w3-center w3-padding">
                    <img class="w3-image w3-round w3-margin" src="images/<?php echo $pcode ?>.png" onerror=this.onerror=null;this.src="images/products.png" style="width:100%; max-width:600px"><br>
                ...
                <p>
                    ...
                    <input class="w3-input w3-border w3-round" name="pcode"  type="text" value="<?php echo $pcode ?>"  readonly="readonly" required>
                </p>
                <p>
