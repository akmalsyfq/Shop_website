...
<a  href="logout.php"  class="w3-bar-item  w3-button  w3-right">Login</a>
<a  href="#"  class="w3-bar-item  w3-button  w3-left">Cart</a>
</div>
...
echo "<table class='w3-table'><tr>
            <td class='w3-center'><a href=#?id=$pcode>
            <i class='fa fa-shopping-basket' style='font-size:32px' onClick=
            'return ' style='text-decoration:none'></i></a></td>
            <td class='w3-center'><a href='#?id=$pcode'>
            </a></td>
            </tr></table>";
echo  "</div>"; 
